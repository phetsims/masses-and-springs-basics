 ...
 * please modify masses-and-springs-basics/package.json to control dependencies.
 *
 * RequireJS configuration file for the masses-and-springs-basics sim.
 * Paths are relative to the location of this file.
 */

require.config( {

  deps: [ 'masses-and-springs-basics-main' ],
